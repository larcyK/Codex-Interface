...
export const stripAnsi = (text) => text.replace(ANSI_ESCAPE_RE, "");
...
export const parseAnsiLine = (line) => {
    const spans = [];
...
export const buildTerminalBlocks = (streamOutput) => {
...
export const extractDisplayOutput = (rawOutput) => {
